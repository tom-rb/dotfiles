---
name: ste-writing
description: Write or rewrite prose (docs, READMEs, PR descriptions, error messages, release notes, comments — never code) into ASD-STE100 Simplified Technical English to remove "AI slop". Use whenever writing technical documentation. Two modes — strict (procedures/safety) and STE-flavored (general prose).
---
